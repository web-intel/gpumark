...
public:
    ...
    std::wstring TextureFile() const { return mTextureFile; }
...
public:
    GUISprite(int x, int y, int width, int height, const std::wstring& spriteFile)
...
public:
    ...
    GUISprite* AddSprite(int x, int y, int width, int height, const std::wstring& spriteFile)
    {
