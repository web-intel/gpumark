...
//--------------------------------------------------------------------------------------
_Use_decl_annotations_ HRESULT FindDXSDKShaderFileCch(WCHAR *strDestPath,
                                                      int cchDest,
                                                      LPCWSTR strFilename)
{
...
void D3D12Sample::LoadAssets()
{
...
#ifdef USE_SLM_8X8_4X16
    FindDXSDKShaderFileCch( str, MAX_PATH, LPCWSTR(L"../../src/compute/slm_8X8_4X16.hlsl") );
    ThrowIfFailed(D3DCompileFromFile(str, nullptr, nullptr, "CSMain", "cs_5_0", compileFlags, 0, &computeShader, nullptr));
#else
    ...
    FindDXSDKShaderFileCch( str, MAX_PATH, LPCWSTR(L"../../src/compute/slm_4x4_16x16.hlsl") );
    ThrowIfFailed(D3DCompileFromFile(str, defines, nullptr, "main", "cs_5_0", compileFlags, 0, &computeShader, nullptr));
#endif
...
void D3D12Sample::RunCompute()
{
    ...
    for (UINT it = 0; it < m_computeCount; it++)
    {
    ...
    printf("Avg Host GFlops = %f, Avg kernel GFlops = %f, Peak Kernel GFlops = %f\n"
		    "Avg_time = %f us, Avg_kernel_time = %f ms, min_time = %f ms\n",
