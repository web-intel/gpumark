...
constexpr int g_smallFishCount             = 100;
constexpr int g_mediumFishCount            = 1000;
constexpr int g_bigFishCount               = 10000;
constexpr int g_leftSmallFishCount         = 80;
constexpr int g_leftBigFishCount           = 160;
