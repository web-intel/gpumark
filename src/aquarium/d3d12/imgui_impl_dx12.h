...
IMGUI_IMPL_API void ImGui_ImplDX12_NewFrame(int MSAACount, bool enableAlphaBlending);
...
IMGUI_IMPL_API bool ImGui_ImplDX12_CreateDeviceObjects(int MSAACount, bool enableAlphaBlending);
